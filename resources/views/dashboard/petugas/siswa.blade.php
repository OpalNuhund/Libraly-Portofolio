                  ...
                  <tbody>
                        @foreach ( $siswa as $item )
                           <tr>
                              ...
                              <td>{{ $item->no_tlp }}</td>
                              <td>
                                 <a href="dashboard-petugas-siswa/edit-siswa-{{ $item->name }}" class="btn-edit" data-type="book">Edit</a>
                                 <a href="/petugas/dashboard-petugas-siswa/delete-siswa-{{ $item->name }}" class="btn-delete" data-type="book">Delete</a>
                              </td>
                           </tr>
                        @endforeach
                  </tbody>
