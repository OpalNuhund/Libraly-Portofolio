...
@section('content')
   ...
   <form class="crud-form" aria-label="Tambah kategori form" action="/petugas/dashboard-petugas-kategori/add-kategori" method="POST">
      @csrf
      ...
      <a href="/petugas/dashboard-petugas-kategori" class="btn-back" data-type="book">Kembali</a>
   </form>
@endsection
