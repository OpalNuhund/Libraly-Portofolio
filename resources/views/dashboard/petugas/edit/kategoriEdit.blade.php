...
@section('content')
               ...
               <form class="crud-form" aria-label="Tambah kategori form" action="/petugas/dashboard-petugas-kategori/edit-kategori-{{ $categories->name }}" method="POST">
                  @csrf
                  @method('put')
                  ...
                  <a href="/petugas/dashboard-petugas-kategori" class="btn-back">Batal</a>
               </form>
@endsection
